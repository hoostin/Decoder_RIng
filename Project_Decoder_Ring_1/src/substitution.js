...
const substitutionModule = (function () {
  ...
  /**
   * function used by substitution to translate input from alphabet1 to alphabet2
   * @param {string} input message to translate
   * @param {Array} alphabet1 original alphabet
   * @param {Array} alphabet2 alphabet to translate with
   */
